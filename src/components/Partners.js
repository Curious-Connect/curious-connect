            ...
            <Slider {...settings}>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner1.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner2.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner3.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner4.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner5.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner6.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner7.jpeg" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
              <div className="swiper-slide">
                <div className="partner-img">
                  <img src="images/partner8.png" style={{ margin: "auto" }} alt="photo de partenaire" />
                </div>
              </div>
            </Slider>
          </section>
