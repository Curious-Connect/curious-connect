...
export default class Contact extends Component {
  ...
  render() {
    ...
    */}{" "}
              Les inscriptions pour le programme sont ouvertes jusqu'au jeudi 18
              juin à minuit ici :
            </p>
            <div
              ...
              onClick={() => {
                ...
                window.open("https://airtable.com/shrgwstMyHD7XFQFB", "_blank");
              }}
              cs
            >
              Inscription{" "}
            ...
            <p></p>
            <p className="text-lg line-height-1_8">
              Pour toute question, contacte-nous :<br></br>
          ...
          {/*           <div className="row justify-content-center">
            <div className="col-lg-6">
              ...
              <form className="contact__form form-group" onSubmit={this.handleFormSubmit}>
                ...
                <button className="btn contact__btn" type="submit">Envoyer</button>
              </form>      
            </div>
          </div>     */}
        </div>
